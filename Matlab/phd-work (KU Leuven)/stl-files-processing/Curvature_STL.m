clear all; close all;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Curvature_3points: Estimates the curvature of a STL according to the
%                       manual selection of 3 points
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Dependencies:        
%               STL_ReadFile.m 
...
%           STL: STL file
% Output:
%           Estimation of the curvature based on the calculation of the
%           radius of the circle passing by 3 manually selected points
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% FILE
STL = 'N_MC1_S-1-0.4.stl';

% Read STL file
[F_STL, V_STL] =  STL_ReadFile([dir STL],true);

% Plot the STL
stl = figure;
    [obj, li, ax] = GUI_PlotShells(stl, {F_STL}, {V_STL},...
            {ones(size(V_STL,1),1)});
...
% Select 3 relevant points to estimate the curvature

    % Point 1
disp(' ')
cprintf('Keywords','Select the first point (P1)')
...
if k1==0
    ...
    % Point 2
disp(' ')
cprintf('Keywords','Select the second point (P2)')
