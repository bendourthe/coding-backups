...
insertion_lig_available = 0;    % loads data if available (=1), else, generate data
...
f7=figure;
plot(t,magn_SAOL,'r',t,magn_DRL,'b');
xlabel('time (s)');
ylabel('Tension in the ligaments (N)')
legend('SAOL','DRL','Location','NorthEastOutside')
