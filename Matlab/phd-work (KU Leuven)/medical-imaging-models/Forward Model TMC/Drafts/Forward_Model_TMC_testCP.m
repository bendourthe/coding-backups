...
f10=figure;
plot(t,Tt(:,1),'r',t,Ttot_lig(:,1),'g',t,Ttot_carti(:,1),'b');
xlabel('time (ms)');
ylabel('Tx (N.mm)')
legend('Ttot-x','Tlig-x','Tcart-x','Location','NorthEastOutside')
set(gcf,'numbertitle','off','name','Evolution of the torque on X');

% Plots the evolution of the torque on the y-axis through time
f11=figure;
plot(t,Tt(:,2),'r',t,Ttot_lig(:,2),'g',t,Ttot_carti(:,2),'b');
xlabel('time (ms)');
ylabel('Ty (N.mm)')
legend('Ttot-y','Tlig-y','Tcart-y','Location','NorthEastOutside')
set(gcf,'numbertitle','off','name','Evolution of the torque on Y');

% Plots the evolution of the torque on the y-axis through time
f12=figure;
plot(t,Tt(:,3),'r',t,Ttot_lig(:,3),'g',t,Ttot_carti(:,3),'b');
xlabel('time (ms)');
ylabel('Tz (N.mm)')
legend('Ttot-z','Tlig-z','Tcart-z','Location','NorthEastOutside')
