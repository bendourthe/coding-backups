...
dir = 'C:\Users\u0096636\Documents\Professional\PhD KU Leuven\Data\Study_Brown_Rig\Subjects data\Scan3\STL\';
...
Def1 = (Ttot - D(D < Ttot).') + 1;
for i=1:length(Def1)
    CS(i) = 1/4*HA*(1 + d1*(Def1(i) - 1))*1/Def1(i)*(Def1(i).^2 - 1/(Def1(i).^2));
end
