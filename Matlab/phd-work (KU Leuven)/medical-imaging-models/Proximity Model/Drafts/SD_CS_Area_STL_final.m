...
d0 = 0.70;            % Initial solid content (material constant)
...
Tmc1 = 0.8;           % Average first metacarpal cartilage thickness (mm)
...
% Read STL files
[F_Bone1, V_Bone1] =  STL_ReadFile([dir Bone2],true);
[F_Bone2, V_Bone2] =  STL_ReadFile([dir Bone1],true);
...
% distribution in the compression zone
area2 = figure; 
    [obj, li, ax] = GUI_PlotShells(area2, {F_Bone1}, {V_Bone1},...
            {ones(size(V_Bone1,1),1)},[0,0,1]);
box off
