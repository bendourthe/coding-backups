...
for i=1:length(XB1)
    ...
    if (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) >= 0.20*max(CS) && (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) < 0.40*max(CS)
        mcyan1(i)=XB1(i);
        hold on
        cyan1 = scatter3(XB1(i),YB1(i),ZB1(i),'fill','c');
    end
    if (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) >= 0.40*max(CS) && (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) < 0.60*max(CS)
        mgreen1(i)=XB1(i);
        hold on
        green1 = scatter3(XB1(i),YB1(i),ZB1(i),'fill','g');
    end
    if (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) >= 0.60*max(CS) && (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) < 0.80*max(CS)
        myellow1(i)=XB1(i);
        hold on
        yellow1 = scatter3(XB1(i),YB1(i),ZB1(i),'fill','y');
    end
    if (1/4*HA*(1 + d1*(Def(i) - 1))*1/Def(i)*(Def(i).^2 - 1/Def(i).^2)) >= 0.80*max(CS)
        mred1(i)=XB1(i);
        hold on
