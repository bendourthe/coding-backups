...
% systems. Transformations of eache bone relative to the more proximal one
% 
% FK, 17/4/2013, Added description and dependencies.
% FK, 28/10/2014, Added Transformations of eache bone relative to the more
%                   proximal one
...
dir = 'C:\Users\u0096636\Documents\Professional\PhD KU Leuven\Data\Study_Faes_4D_CT\STL\'; % Folder with files
data_available = 0; % loading data if available (=1), else, generate data
    filename = 'RotTransData_tovStat27.txt';
    file = [dir filename];
...
filenameInertialAX = 'InertialAx27.txt';
...
MC_frag = '611L_phase27_mc1.stl';
MC_static = '611L_static_mc1.stl';
Sca1 = '611L_phase27_sca.stl';
Sca_static = '611L_static_sca.stl';
Trap1 = '611L_phase27_trp.stl';
