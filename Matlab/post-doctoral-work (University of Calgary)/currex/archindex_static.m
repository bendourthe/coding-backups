...
filename='1_101_cs_v_1.csv';

data=importfile_static(filename); % imports currex data
...
AI.left=arch.act.left/cells.act.left; % calculates Arch Index based on the number of active cells in the arch divided by the overall number of active cells in the foot
AI.right=arch.act.right/cells.act.right;
