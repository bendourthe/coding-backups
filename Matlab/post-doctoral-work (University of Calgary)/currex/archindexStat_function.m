function [AILeft,AIRight] = archindexStat_function(data)
%% DESCRIPTION:
%
% [AILeft,AIRight] = archindexStat_function(data)
%
...
%
%% Output:
%   - AILeft: Arch index of the left foot
%   - AIRight: Arch index of the right foot
