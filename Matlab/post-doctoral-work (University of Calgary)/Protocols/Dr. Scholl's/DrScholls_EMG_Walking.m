...
%% Directory
    ...
    cd 'D:\Dr. Scholls\Pilot\Protocol V3\Ben_incline\5\';
    pathName = 'D:\Dr. Scholls\Pilot\Protocol V3\Ben_incline\5';
...
%% Data processing
    ...
    for i=1:numSessions
        ...
        for j=1:recTime
            ...
            for k=1:numSteps
                % Wavelet transform
                [pGL, intGL, tIntGL, fGL, paGL] = emg_wavelet_act(reshapedEmgGL(:,k),...
