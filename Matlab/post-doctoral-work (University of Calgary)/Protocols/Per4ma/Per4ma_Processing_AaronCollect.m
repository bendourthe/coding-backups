...
for s = 10
    ...
    for a = 1:4
        ...
        ctrlfile = [directory datafolder subj '\' subj pass CTRL '.csv'];
    ...
    for b = 1:2
        % Under Armor
        UA = sprintf('UA%d',(b));
        uafile = [directory datafolder subj '\' subj pass UA '.csv'];
        ...
        % X-Act
        XA = sprintf('XA%d',(b));
        xafile = [directory datafolder subj '\' subj pass XA '.csv'];
...
for sss = 10:23
    ...
    for d = 1:3
        ...
        directory = 'C:\Users\chris.lam1\Dropbox\Per4ma - X-ACT\';
        savefolder = 'Results\';
        datafolder = 'Raw Data\';
        load('Per4madata.mat')
        ...
        if d == 1
            filedir = [directory datafolder subj '\' ctrl '\' subj act ctrl];
            e = 1;
            cf = 20; % center frequency
            
        elseif d == 2
            filedir = [directory datafolder subj '\' ua '\' subj act ua];
            e = 3;
            cf = 20; % center frequency
        ...
        elseif d == 3
            filedir = [directory datafolder subj '\XA\' subj act xa];
            e = 5;
            cf = 20; % center frequency
