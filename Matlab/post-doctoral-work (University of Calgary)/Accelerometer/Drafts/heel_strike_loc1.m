function [numSteps, frameLength, heelStrikeLoc] = heel_strike_loc(signal, sampling_frequency)
%% DESCRIPTION:
%
...
% Finds the location of each max peak of the reshaped signal (gives us
% the location of the heel strike within each frame)
...
for i=1:numSteps-2
    heelStrikeLoc(i) = peakIdx(i+1)+(i)*frameLength;
end