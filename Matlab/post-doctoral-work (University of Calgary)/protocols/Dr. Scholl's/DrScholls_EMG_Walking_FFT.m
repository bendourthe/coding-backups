...
%% Directory
    ...
    cd 'D:\Dr. Scholls\Pilot\Protocol V3\Anke_incline\';
    pathName = 'D:\Dr. Scholls\Pilot\Protocol V3\Anke_incline';
...
%% Data processing
    ...
    for i=1:numSessions
        ...
        for j=1:recTime
            ...
            for k=1:numSteps
                % FFT
                [pGL, intGL, stepMtiGL(k), fGL, stepMnfGL(k)] = emg_fft_act_fix(reshapedEmgGL(:,k),...
